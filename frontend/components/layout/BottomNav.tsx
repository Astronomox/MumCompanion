...
function ChatIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill={active ? "currentColor" : "none"} className="w-6 h-6">
      <path d="M4 6a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v7a3 3 0 0 1-3 3H9l-5 4v-4a3 3 0 0 1 0-10Z" stroke="currentColor" strokeWidth="2.2" strokeLinejoin="round"/>
    </svg>
  )
}
...
function JourneyIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
      <rect x="4" y="5" width="16" height="16" rx="3" stroke="currentColor" strokeWidth="2.2" fill={active ? "currentColor" : "none"} fillOpacity={active ? "0.15" : "0"}/>
...
function MoveIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
      <circle cx="12" cy="5" r="2.2" fill={active ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2.2"/>
      <path d="M12 8V15M12 11L7 13M12 11L17 13M12 15L9 21M12 15L15 21" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/>
    </svg>
  )
}
...
function ScanIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
      <path d="M4 8V6a2 2 0 0 1 2-2h2M16 4h2a2 2 0 0 1 2 2v2M20 16v2a2 2 0 0 1-2 2h-2M8 20H6a2 2 0 0 1-2-2v-2" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round"/>
      <path d="M4 12H20" stroke="currentColor" strokeWidth={active ? "2.8" : "2.2"} strokeLinecap="round"/>
    </svg>
  )
}
...
function GearIcon({ active }: { active: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className="w-6 h-6">
      <path d="M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z" stroke="currentColor" strokeWidth={active ? "2.6" : "2.2"} strokeLinecap="round" strokeLinejoin="round"/>
