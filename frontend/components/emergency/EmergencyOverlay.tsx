...
function HospitalIcon({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      <rect x="4" y="7" width="16" height="14" rx="2" stroke="currentColor" strokeWidth="2.3"/>
      <path d="M9 3 h6 v4 H9 Z" stroke="currentColor" strokeWidth="2.3"/>
      <path d="M12 11 v6 M9 14 h6" stroke="currentColor" strokeWidth="2.3" strokeLinecap="round"/>
    </svg>
  )
}
