...
import { MotherAndChildIllustration } from "@/components/svg/MotherAndChildIllustration"
...
function LoginContent() {
  ...
  return (
    <div className="min-h-dvh flex flex-col lg:flex-row bg-cream-50">
      ...
      {/* LEFT - Hero illustration (desktop only, top strip on mobile) */}
      <div className="hidden lg:flex lg:w-1/2 relative bg-forest-900 overflow-hidden">
        <div className="absolute inset-0 flex items-center justify-center p-12">
          <MotherAndChildIllustration className="w-full max-w-lg h-auto" />
        </div>

        {/* Overlay quote at bottom */}
        <div className="absolute inset-x-0 bottom-0 p-10 bg-gradient-to-t from-forest-900 via-forest-900/85 to-transparent">
          <div className="max-w-md">
            <p className="font-display text-2xl text-cream-50 leading-snug">
              &ldquo;Welcome back, nne. Let us pick up where we left off.&rdquo;
            </p>
            <p className="mt-3 text-sm text-forest-100/70">
              MamaBot, your companion through every season.
            </p>
          </div>
        </div>
      </div>
      ...
      {/* Mobile hero strip */}
      <div className="lg:hidden relative h-40 bg-forest-900 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-40">
          <MotherAndChildIllustration className="w-full h-full object-cover" />
        </div>
      ...
      <div className="flex-1 lg:w-1/2 flex flex-col">
          ...
          <div className="w-full max-w-md">
            <div className="mb-8">
              ...
              <p className="mt-2 text-stone-600">
                Sign in to continue your journey with MamaBot.
              </p>
            </div>
        ...
        <div className="px-5 sm:px-8 pb-6 text-center">
          <p className="text-[11px] text-stone-400">
            By signing in, you agree to our terms and acknowledge that MamaBot provides
