    ...
    return (
      <div className="min-h-dvh bg-cream-50 flex items-center justify-center px-5">
        <div className="max-w-md text-center">
          ...
          <p className="mt-3 text-stone-600">We sent a confirmation link to <span className="font-medium text-stone-800">{email}</span>. Click it to activate your account.</p>
          <Link href="/login" className="mt-8 inline-flex items-center gap-2 text-terracotta-500 hover:text-terracotta-600 font-semibold">
  ...
  return (
    <div className="min-h-dvh flex flex-col lg:flex-row bg-cream-50">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1560328055-e938bb2ed50a?w=800&q=80')",
          backgroundSize: "cover",
          backgroundPosition: "center 30%",
        }}
      >
        <div className="absolute inset-0" style={{ background: "rgba(217,94,42,0.55)" }}/>
      ...
      <div className="flex-1 lg:w-1/2 flex flex-col order-2 lg:order-1">
        ...
        <div className="flex-1 flex items-center justify-center px-5 sm:px-8 py-8 lg:py-12">
          <div className="w-full max-w-md">
            <div className="mb-8">
              ...
              <p className="mt-2 text-stone-600">Free forever. No card needed. Just answers when you need them.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" disabled={loading || !name || !email || !passwordOk}
                ...
                {loading ? (<><Spinner className="w-4 h-4"/>Creating your account...</>) : (<>Create my account<ArrowRight className="w-4 h-4"/></>)}
              </button>
            </form>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-stone-600">
                ...
                <Link href="/login" className="font-semibold text-terracotta-500 hover:text-terracotta-600">Sign in</Link>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 sm:px-8 pb-6 text-center">
          <p className="text-[11px] text-stone-400">By creating an account, you agree to our terms. MamaBot provides guidance, not medical advice.</p>
        </div>
      </div>

      {/* RIGHT: Real photo hero */}
      <div
        className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col justify-end order-1 lg:order-2"
        style={{
          backgroundImage: "url('https://images.unsplash.com/photo-1560328055-e938bb2ed50a?w=1200&q=85')",
          backgroundSize: "cover",
          backgroundPosition: "center 30%",
        }}
      >
        <div
          ...
          style={{ background: "linear-gradient(180deg, rgba(217,94,42,0.2) 0%, rgba(28,57,32,0.88) 100%)" }}
        />
        <div className="relative z-10 p-10 space-y-3">
          <p className="font-display text-xl text-white font-bold mb-4">What you get on day one</p>
          {[
